...
public class MathFragment extends Fragment {
    ...
    public static MathFragment newInstance(String tittle){
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        refreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshlayout) {
                ...
                getArticleList();
                Toast.makeText(getContext(), "数学文章刷新完毕", Toast.LENGTH_SHORT).show();
        ...
        Api.config("/artitle/getAllArtitle",null).getRequest(getActivity(), new TtitCallback() {
            ...
            public void onSuccess(String res) {
                ...
                for (ArtitleBean artitleBean : artitleBeans){
                    if(artitleBean.getCategory().equals("math"))
                ...
                (getActivity()).runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        System.out.println("MathFragment 69");
