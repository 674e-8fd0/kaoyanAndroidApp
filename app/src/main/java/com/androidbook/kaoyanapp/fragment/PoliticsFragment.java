...
public class PoliticsFragment extends Fragment {
    ...
    public static PoliticsFragment newInstance(String tittle){
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        refreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshlayout) {
                ...
                getArticleList();
                Toast.makeText(getContext(), "政治文章刷新完毕", Toast.LENGTH_SHORT).show();
        ...
        Api.config("/artitle/getAllArtitle",null).getRequest(getActivity(), new TtitCallback() {
            ...
            public void onSuccess(String res) {
                ...
                for (ArtitleBean artitleBean : artitleBeans){
                    if(artitleBean.getCategory().equals("politics"))
